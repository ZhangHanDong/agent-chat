...
dashboard -> node server.js         -> TCP HAGENCY_WEB_PORT
...
- Create: `services/hagency-services.mjs`
...
- CLI: `node services/hagency-services.mjs start|run|status|doctor|stop`.
...
`specs/phase1/fsf0-b1-hagency-services.spec.md`; expected quality 100%.
