...
const REPO_ROOT = process.env.HAGENCY_ARCH_BOUNDARY_ROOT
  ? path.resolve(process.env.HAGENCY_ARCH_BOUNDARY_ROOT)
  : path.resolve(SCRIPT_DIR, '..');
const MANIFEST_PATH = process.env.HAGENCY_ARCH_BOUNDARY_MANIFEST
  ? path.resolve(process.env.HAGENCY_ARCH_BOUNDARY_MANIFEST)
