...
const asCredential = () => ({ kind: 'appservice', asToken: 'old-as-secret', hsToken: 'old-hs-secret', url: 'http://127.0.0.1:8009', namespace: '@ac_.*', senderLocalpart: 'hafleet' });
...
const side = (credential, extra = {}) => ({ id: 'palpo.test', serverName: 'palpo.test', apiBaseUrl: 'http://127.0.0.1:8008', label: 'Existing project side', credential, representative: { mxid: '@hafleet:palpo.test', localpart: 'hafleet', observedAt: 10 }, active: true, accessState: 'accepted', accessCheckedAt: 10, createdAt: 1, updatedAt: 10, projects: {}, pendingCredential: null, ...extra });
