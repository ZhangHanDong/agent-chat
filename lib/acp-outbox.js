 ...
 *
 * This exists because octos 2.0.2 has no way to reach Hagency. It accepts the
...
export const OUTBOX_PROTOCOL = [
  'To send a message yourself, write a JSON file into .hagency/outbox/ in your',
  ...
  '.hagency/outbox/rejected/ with a .error file beside it explaining why.',
].join('\n');
