 ...
 *
 *   - bin/hagency-up:1640-1644 unsets ANTHROPIC_API_KEY for a Claude agent unless
 ...
 * (bin/hagency-up only unsets the env key when the profile has none), and it bills
