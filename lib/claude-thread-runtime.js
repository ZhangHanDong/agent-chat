...
export function prepareClaudeThreadRuntime(agent, { repoRoot, runtimeRoot, apiBaseUrl, serverName }) {
  ...
  config.mcpServers[serverName] = {
    ...
    env: { AGENT_NAME: agent.name, HAGENCY_API: apiBaseUrl, HAGENCY_RUNTIME_DIR: runtimeRoot,
      HAGENCY_MCP_SERVER_NAME: serverName, HAGENCY_AGENT_STATE_DIR: agent.stateDir },
  };
