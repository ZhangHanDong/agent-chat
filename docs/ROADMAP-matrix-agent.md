# Roadmap — matrix-Agent execution layer (hagency)
...
result; **hagency is matrix-Agent** — it owns *agent pooling, capability scheduling, and the
...
- Robrix2 renders structured events and emits button responses; hagency
...
*gating*), in-toto/SLSA signing, the N-of-M release gate, and AI-BOM. hagency still owns the
