...
hagency is primarily a chat kernel for agents as persistent individuals. The kernel must answer these questions consistently:
...
| Launch/provisioning | `bin/hagency-up`, `bin/hagency-up-v1`, `scripts/provision-v1-agent-home.js` | Creates runtime homes and sessions; must preserve one identity mapping. |
