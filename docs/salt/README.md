...
This folder is the working documentation set for the current hagency system audit.
The target interpretation is:

- Core: hagency kernel, where an agent is treated as an addressable, stateful, remembered individual.
