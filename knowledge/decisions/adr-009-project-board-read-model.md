...
hagency already persists the facts needed for a useful project operations
...
The backend owns a read-only project-board projection. An hagency group is
...
resources and daemon-local directories, extended for hagency's multi-agent
